...
png(filename ="plot4.png", bg = "transparent") ## default size is 480 by 480 which is correct so don't need to set

## set up graphic display for 2 by 2 plots, plotting column by column (ie down then across)
par(mfcol = c(2,2))
...
with(datasubset, plot(datetime, Global_active_power, type ="l", xlab ="", ylab ="Global Active Power"), breaks = 3)
...
## create legend  in "topright" position, turn off boundary with "bty" = n
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty = "n")

##-----------------------------------------------------------------------------
##              Create third plot
with(datasubset, plot(datetime, Voltage, type ="l", col = "black"), breaks = 3)

##-----------------------------------------------------------------------------
##              Create fourth plot
with(datasubset, plot(datetime, Global_reactive_power, type ="l", col = "black"), breaks = 3)
...
msg <- "plot4.R script complete, plot4.png produced in R working directory"
